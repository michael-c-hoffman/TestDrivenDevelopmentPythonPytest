...
def isortFix():
    os.system("isort awsInfrastructure tests scripts")

def blackTests():
    pytest.main(["--black", "-m", "black"])

def blackFix():
    os.system("black awsInfrastructure tests scripts")
...
def pytestCovTerm():
    pytest.main(["--cov-report=term-missing", "--cov=awsInfrastructure", "tests/"])

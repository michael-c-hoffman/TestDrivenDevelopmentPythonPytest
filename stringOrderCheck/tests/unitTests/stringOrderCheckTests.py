...
from stringOrderCheck.stringOrder import (
    orderIndices,
    checkOrder,
    orderScan,
)
...
@pytest.mark.parametrize('inputSource, inputOrder, expected',
                         [
                             ("helloworld", "hlo!", list()),
...
@pytest.mark.parametrize('inputSource, inputOrder, ,nextchar, expected',
                         [

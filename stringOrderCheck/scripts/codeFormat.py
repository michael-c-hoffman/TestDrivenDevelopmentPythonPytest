...
def isortFix():
    os.system("isort stringOrderCheck tests scripts")

def blackTests():
    pytest.main(["--black", "-m", "black"])

def blackFix():
    os.system("black stringOrderCheck tests scripts")
...
def pytestCovTerm():
    pytest.main(["--cov-report=term-missing", "--cov=stringOrderCheck", "tests/"])
